...
const now = (format) => (0, moment_timezone_1.default)().tz('Asia/Manila').format(format || 'Y-MM-DD HH:mm:s');
exports.now = now;
// Reformat
const formatDate = (dt, format) => (0, moment_timezone_1.default)(dt).format(format || 'Y-MM-DD HH:mm:s');
exports.formatDate = formatDate;
// Return the date 7 days ago
const sevenDaysAgo = (format) => (0, moment_timezone_1.default)().tz('Asia/Manila').subtract(7, 'days').format(format || 'Y-MM-DD HH:mm:s');
